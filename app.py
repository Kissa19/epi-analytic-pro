...
if not st.session_state['registered']:
    ...
    st.sidebar.warning("⚠️ โปรดลงทะเบียนเพื่อปลดล็อกเมนูวิเคราะห์ 🚫 คำเตือนความปลอดภัย: โปรดตรวจสอบไฟล์ Excel และลบคอลัมน์ ชื่อ-นามสกุล หรือข้อมูลระบุตัวตนออกก่อนอัปโหลดเข้าสู่ระบบ")
else:
